...
private:
    ...
    std::array<VkImageView, CASCADE_COUNT> m_layerImageViews{VK_NULL_HANDLE, VK_NULL_HANDLE, VK_NULL_HANDLE};
    VkImageView m_arrayImageView = VK_NULL_HANDLE;
    VkSampler m_sampler = VK_NULL_HANDLE;

    std::array<glm::mat4, CASCADE_COUNT> m_cascadeViewProjs{};
    std::array<float, CASCADE_COUNT> m_cascadeSplits{16.0f, 54.0f, 200.0f};
